<div id="donation-area">
    ...
    <div class="container ">
        <div class="row">
            ...
            <div style="height: 50%;"  class="col-12 text-center">
                <img style="height:800px" src="img/doacao.svg" alt="doação de  alimento">
        ...
        <div class="row">
            ...
            <div style="height:50%;" class="col-12 text-center">
                <img style="height:800px" class="img-fluid" src="img/receber.svg" alt="recepção de alimento">
