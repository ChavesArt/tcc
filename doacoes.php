...
<div id="donation-area" class="my-5">
    ...
    <div class="container">
        ...
        <div class="row align-items-center mb-5 mid">
            <div class="col-md-6 text-center mb-4 mb-md-0 texto">
                ...
                <a class="btn btn-primary btn-lg" style="text-align: center;" href="formdoar.php">Doar</a>
            </div>
